...
-- CreateEnum
CREATE TYPE "TableStatus" AS ENUM ('EMPTY', 'OCCUPIED', 'WAITING_ORDER', 'ASKING_BILL', 'CLOSED');

-- CreateEnum
CREATE TYPE "OrderSource" AS ENUM ('CASHIER', 'QR_MENU');

-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('OPEN', 'PENDING_APPROVAL', 'CONFIRMED', 'CANCELLED', 'PAID');

-- CreateEnum
CREATE TYPE "PaymentMethod" AS ENUM ('CASH', 'CARD', 'MEAL_CARD', 'TRANSFER', 'MIXED');

-- CreateEnum
CREATE TYPE "ExpenseCategory" AS ENUM ('FOOD_SUPPLY', 'RENT', 'ELECTRICITY', 'WATER', 'STAFF', 'OTHER');
