  ...
  return (
    <aside className="fixed left-0 top-0 bottom-0 w-[240px] z-50 flex flex-col bg-[#0c0c14] border-r border-white/[0.06] px-3 py-5">
      ...
      <nav className="flex flex-col gap-0.5 flex-1">
        <p className="text-[10px] font-semibold text-white/25 tracking-widest uppercase px-3 mb-1">Menü</p>
      ...
      <div className="pt-3 border-t border-white/[0.06]">
        <Link
          href="/login"
          className="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium text-white/35 hover:text-red-400 hover:bg-red-500/8 transition-all duration-150"
        >
